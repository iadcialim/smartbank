...
export class AccountsService {
   ...
   */
  static async getUserAccountsByType(
   ...
   */
  static async getAccountsGroupedByType(): Promise<
    ApiResponse<Record<string, Account[]>>
  > {
    try {
      const accountsResponse = await this.getUserAccounts()
      ...
      const groupedAccounts = accountsResponse.data.reduce(
        (groups, account) => {
